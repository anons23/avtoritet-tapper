...
const R=[['Салага',0],['Пацан',500],['Блатной',2500],['Смотрящий',10000],['Авторитет',40000]];
const O=[['Груша','🥊',1,0],['Сокамерник','👊',1.3,500],['Отжимания','💪',1.6,2500],['Тренажёр','🏋️',2.2,10000],['Разборка','🗣️',3.2,40000]];
...
function updateRankGoal(){
  ...
  if(!next){
    ...
    value.textContent='40 000 ⭐ · максимум';
