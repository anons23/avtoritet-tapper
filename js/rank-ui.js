...
(function(){
  ...
  function init(){apply();const p=document.getElementById('points');if(p)new MutationObserver(()=>{apply();renderMenu()}).observe(p,{childList:true,characterData:true,subtree:true});const o=document.getElementById('modal-overlay');if(o)new MutationObserver(renderMenu).observe(o,{childList:true,subtree:true,characterData:true});setInterval(()=>{apply();renderMenu()},500)}
